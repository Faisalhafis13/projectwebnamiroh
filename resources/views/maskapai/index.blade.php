    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content shadow">
            ...
            <div class="modal-body px-4 py-4">
                ...
                <input type="hidden" id="maskapai_id">
...
let modal = new bootstrap.Modal(
    document.getElementById('maskapaiModal')
);
...
function loadData(){
 ...
 showLoading();
    fetch("{{ route('api.maskapai.index') }}", {
...
.addEventListener('keyup', function(){
    ...
    let filtered = allData.filter(item =>
        ...
        item.nama_maskapai.toLowerCase().includes(keyword)

        ||

        item.kode_maskapai.toLowerCase().includes(keyword)
    );
...
function openModal(){
    ...
    document.getElementById('maskapai_id').value = '';

    document.getElementById('nama_maskapai').value = '';

    document.getElementById('kode_maskapai').value = '';
...
function editData(
    ...
    document.getElementById('maskapai_id').value = id;

    document.getElementById('nama_maskapai').value = nama_maskapai;

    document.getElementById('kode_maskapai').value = kode_maskapai;
...
showLoading();
    ...
    let id = document.getElementById('maskapai_id').value;

    let nama_maskapai = document.getElementById('nama_maskapai').value;

    let kode_maskapai = document.getElementById('kode_maskapai').value;
