    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content shadow">
            ...
            <div class="modal-body px-4 py-4">
                ...
                <input type="hidden" id="perlengkapan_id">
...
let modal = new bootstrap.Modal(
    document.getElementById('perlengkapanModal')
);
...
function loadData(){
    ...
    fetch("{{ route('api.perlengkapan.index') }}", {
...
function renderTable(data = null){
    ...
    let tbody = document.querySelector("#perlengkapanTable tbody");
...
.addEventListener('keyup', function(){
    ...
    let filtered = allData.filter(item =>
        ...
        item.nama_perlengkapan.toLowerCase().includes(keyword)
    );
...
function openModal(){
    ...
    document.getElementById('perlengkapan_id').value = '';

    document.getElementById('nama_perlengkapan').value = '';
...
function editData(
    ...
    document.getElementById('perlengkapan_id').value = id;

    document.getElementById('nama_perlengkapan').value = nama_perlengkapan;
...
function saveData(){
    ...
    let id = document.getElementById('perlengkapan_id').value;

    let nama_perlengkapan = document.getElementById('nama_perlengkapan').value;
